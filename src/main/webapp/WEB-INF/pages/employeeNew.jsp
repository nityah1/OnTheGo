		        ...
		        <div class="col-sm-9 col-md-10 main">
		          <h3 class="page-header">Add New Employee</h3>
					...
					<div class="table-responsive">	 
						<form:form method="POST" commandName="employee" action="${pageContext.request.contextPath}/emplAdmin/add">
							<table class="table-striped table-condensed">  
								<tbody>
									<tr>  
								        <td><form:label path="employeeId">Employee ID:</form:label></td>  
								        <td><form:input path="employeeId"></form:input></td>  
     									<td><form:errors path="employeeId" cssClass="red" /></td>
								    </tr>  
									<tr>  
								    ...
								    <tr>  
								        ...
								        <td><form:input path="surname"></form:input></td>  
     									<td><form:errors path="surname" cssClass="red" /></td>
								    </tr>  
								    <tr>  
